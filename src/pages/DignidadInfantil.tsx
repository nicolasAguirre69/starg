    ...
    <>
      ...
      <div className="px-6 md:px-12 lg:px-20 py-16 max-w-5xl mx-auto space-y-12">
        ...
        <section className=" bg-muted  p-8 rounded-2xl shadow-xl border border-white/10">
          ...
          <p className="">
            La{" "}
            <a href="https://www.funcionpublica.gov.co/eva/gestornormativo/norma.php?i=18309" target="_blank"
            ...
            <a href="https://www.alcaldiabogota.gov.co/sisjur/normas/Norma1.jsp?i=7142" target="_blank"
              className=" underline hover:text-teal-200 transition">
              Decreto 67 de 2003
            </a>{" "}y la{" "}
            <a href="https://www.sangil.gov.co/loader.php?lServicio=Tools2&lTipo=descargas&lFuncion=visorpdf&file=https%3A%2F%2Fwww.sangil.gov.co%2Floader.php%3FlServicio%3DTools2%26lTipo%3Ddescargas%26lFuncion%3DexposeDocument%26idFile%3D2534%26tmp%3D969eddabc00d7124a7d12f3744ddc7b2%26urlDeleteFunction%3Dhttps%253A%252F%252Fwww.sangil.gov.co%252Floader.php%253FlServicio%253DTools2%2526lTipo%253Ddescargas%2526lFuncion%253DdeleteTemporalFile%2526tmp%253D969eddabc00d7124a7d12f3744ddc7b2&pdf=1&tmp=969eddabc00d7124a7d12f3744ddc7b2&fileItem=2534" target="_blank"
              className=" underline hover:text-teal-200 transition">
              Ley 1336 de 2009
            </a>{" "} establecen:
          </p>
        ...
        <section className="bg-muted  p-8 rounded-2xl shadow-xl border border-white/10 space-y-4">
          ...
          <div className="grid md:grid-cols-2 gap-6 ">
            ...
            <div className=" p-4 rounded-xl border">
              <strong className="block ">Dirección Central de Policía Judicial â€“ Dijin</strong>
