        ...
        <div className="relative z-10 max-w-4xl mx-auto space-y-12 py-5">          
          ...
          <section className="space-y-6 text-justify">
            <h2 className="text-2xl font-bold text-blue-700">
              Ataque â€œMan-in-the-Middleâ€ (MitM)
            </h2>
            <p>
              El ataque <strong>Man-in-the-Middle (MitM)</strong>, que en
              español significa â€œhombre en el medioâ€, es un tipo de ciberataque
          ...
          <section className="space-y-6 text-justify">
            ...
            <p>
              ...
              (sitios â€œpiratasâ€). Cuando el usuario introduce información en
