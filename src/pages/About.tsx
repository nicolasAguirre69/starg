        ...
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          >
            <p className="text-lg md:text-xl leading-relaxed text-gray-700 dark:text-gray-300">
              En <span className="font-bold text-yellow-500">Star GO</span>,
              nuestra historia es la de tu comunidad. Más que un proveedor de
              servicios de internet, somos vecinos, padres y amigos, dedicados a
              tejer una red que no solo conecta dispositivos, sino que también
              une a las personas.
            </p>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          >
            ...
            <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
              Ofrecer servicios de internet y televisión por fibra óptica de
              alta calidad, asegurando una conexión rápida, estable y confiable
              para los hogares, con atención personalizada y tecnología de
              vanguardia que mejora la experiencia digital de nuestros clientes.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
              Ser la empresa líder en telecomunicaciones del país, reconocida
              por la excelencia en servicio al cliente, innovación tecnológica y
              por conectar a las familias con el mundo a través de una red de
              fibra óptica robusta, eficiente y en constanteÂ evolución.
            </p>
          </motion.div>
        </div>
      </section>
