        ...
        <section className="max-w-6xl mx-auto px-6 md:px-12 lg:px-20 grid md:grid-cols-2 gap-10">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 flex flex-col items-center text-center hover:shadow-2xl transition">
            ...
            <div className="w-full h-[450px] md:h-[450px] rounded-2xl overflow-hidden shadow-lg">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d449.84343458009636!2d-74.16824945229276!3d4.639442700000009!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e3f9d0027c7d2d3%3A0x5e0c3623bd84edff!2sSTARG!5e1!3m2!1ses-419!2sco!4v1756323691288!5m2!1ses-419!2sco"
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 flex flex-col items-center text-center hover:shadow-2xl transition">
            ...
            <div className="w-full h-[450px] md:h-[450px] rounded-2xl overflow-hidden shadow-lg">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d253.1367694999623!2d-74.12067761682827!3d4.620118293811335!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e3f99001e3613ef%3A0x26c463cb1aaf5f69!2sSTARG!5e1!3m2!1ses-419!2sco!4v1756323618086!5m2!1ses-419!2sco"
