export default function HeroSection() {
  return (
    <section className="relative bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 text-white overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-8 px-6 md:px-12 py-16">
        ...
        <div className="space-y-6 text-center lg:text-left order-2 lg:order-1">
          ...
          <p className="text-lg md:text-xl text-gray-200">
            Somos una empresa de <span className="font-semibold text-yellow-400">telecomunicaciones colombiana</span>, 
            comprometida con la innovación y el progreso del país. 
            Ofrecemos <span className="text-yellow-300">fibra óptica de última generación</span>, 
