    ...
    <>
      ...
      <div className="px-6 md:px-12 lg:px-20 py-16 max-w-5xl mx-auto space-y-10 ">
        ...
        <section className="bg-muted backdrop-blur-md rounded-2xl shadow-xl p-8 space-y-4">
          ...
          <p>
            El término <strong>ADPROTV S.A.S.</strong> o â€˜nosotrosâ€™ se refiere al propietario del sitio web. El término â€˜ustedâ€™ se refiere al usuario o visitante de nuestro sitio web. El uso de este sitio web está sujeto a los siguientes términos de uso:
          </p>
        </section>
