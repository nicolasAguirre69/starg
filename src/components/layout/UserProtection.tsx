...
export default function UserProtection() {
  return (
    <section className="relative flex flex-col items-center justify-center gap-10 px-6 md:px-12 lg:px-20 py-10 bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl text-center">
        <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-tight text-white mb-6">
          PROTECCIÓN Y SEGURIDAD EN CADA PASO
        </h1>
        <p className="text-lg md:text-xl text-white leading-relaxed">
          En <span className="font-bold text-yellow-400">Star G</span>, tu
          seguridad es nuestra prioridad. Implementamos las mejores prácticas y
