        ...
        <section className="max-w-6xl mx-auto px-6 md:px-12 lg:px-20 py-20 space-y-20">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-start">
            ...
            <ul className="space-y-4 text-gray-600 dark:text-gray-300">
              <li>
                âœ… <span className="font-semibold">Amplia selección de canales</span> â€“ noticias, deportes, películas y más.
              </li>
              <li>
                âœ… <span className="font-semibold">Contenido a la carta</span> â€“ tus clientes deciden qué ver y cuándo.
              </li>
              <li>
                âœ… <span className="font-semibold">Tecnología de vanguardia</span> â€“ moderna, estable y fácil de usar.
              </li>
            </ul>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            {[
              ...
              },
              {
                ...
                desc: "Ofrece planes â€œtriple playâ€ y aumenta el valor de cada cliente.",
              },
              {
