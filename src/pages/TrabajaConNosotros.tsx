...
import handshakeGif from "@/assets/gif.gif";
    ...
    return (
        ...
        <div className="bg-gray-50 dark:bg-gray-900">
            ...
            <div className="text-center space-y-8">
                <h1 className="py-10 text-3xl md:text-5xl font-extrabold text-blue-700 dark:text-yellow-400">
  ...
  <div className="space-y-6 text-center md:text-left flex-1">
    <h2 className="text-4xl font-bold text-blue-700 dark:text-yellow-400">
      ¿Por qué asociarte con nosotros?
    </h2>
    <p className="text-1xl text-gray-600 dark:text-gray-300 leading-relaxed max-w-3xl">
      En el competitivo mercado de los servicios de internet, destacar es clave.
      Con nuestra programación de televisión, ofreces a tus clientes un valor
      añadido irresistible:{" "}
      <span className="font-semibold">consolidas tu marca</span> y aumentas la
      lealtad. No solo vendes internet, ofreces un{" "}
      <span className="font-semibold">centro de entretenimiento</span> completo.
    </p>
  </div>
    ...
    />
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed mt-4">
                    ...
                    la programación de TV de manera rápida y sin complicaciones.
                    Tú te encargas de la conexión; nosotros de la experiencia.
                </p>
                </div>
                <ul className="space-y-4 text-gray-600 dark:text-gray-300">
                <li>✅ <span className="font-semibold">Amplia selección de canales</span> – noticias, deportes, películas y más.</li>
                <li>✅ <span className="font-semibold">Contenido a la carta</span> – tus clientes deciden qué ver y cuándo.</li>
                <li>✅ <span className="font-semibold">Tecnología de vanguardia</span> – moderna, estable y fácil de usar.</li>
                </ul>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 text-center">
                ...
                >
                    <h3 className="text-xl font-bold text-blue-700 dark:text-yellow-400 mb-4">
                    {item.title}
                    </h3>
            ...
            <div className="text-center space-y-6">
                <h2 className="text-3xl font-extrabold text-blue-700 dark:text-yellow-400">
                ¿Listo para crecer?
                </h2>
